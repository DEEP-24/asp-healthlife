    ...
    <div className="bg-white p-8 rounded-lg shadow-xl">
      ...
      <fetcher.Form method="post" className="space-y-6">
        ...
        <div>
          <Button
            type="submit"
            className="w-full rounded-md bg-green-500 py-2 px-4 text-white hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-150 ease-in-out"
            disabled={isSubmitting}
          >
